...
export const MOCK_PRODUCTS: Product[] = [
  ...
  {
    id: "f1",
    name: "Woxly Minimalist Hoodie",
    slug: "woxly-minimalist-hoodie",
    price: 199.00,
    originalPrice: 249.00,
    rating: 4.8,
    reviewCount: 142,
    description: "Premium organic cotton hoodie designed for comfort.",
    images: ["/images/products/fashion_hoodie.png"],
    category: "Fashion",
    inStock: true,
    stockCount: 80,
    details: ["100% organic cotton", "Thick brushed fleece", "Relaxed fit", "Unisex styling"],
    specs: [{ name: "Material", value: "Organic Cotton" }, { name: "Color", value: "Beige" }],
    vendor: "Woxly Apparel"
  },
  {
    id: "f2",
    name: "Woxly Corduroy Shirt",
    slug: "woxly-corduroy-shirt",
    price: 149.00,
    originalPrice: 179.00,
    rating: 4.7,
    reviewCount: 96,
    description: "Classic corduroy button-up shirt with an elegant finish.",
    images: ["/images/products/fashion_shirt.png"],
    category: "Fashion",
    inStock: true,
    stockCount: 65,
    details: ["Soft-touch fine corduroy", "Buttoned chest pocket", "WOXLY embroidery detail", "Tailored fit"],
    specs: [{ name: "Material", value: "100% Cotton Corduroy" }, { name: "Color", value: "Matte Black" }],
    vendor: "Woxly Apparel"
  },
  {
    id: "f3",
    name: "Woxly Classic Sneakers",
    slug: "woxly-classic-sneakers",
    price: 299.00,
    originalPrice: 349.00,
    rating: 4.9,
    reviewCount: 310,
    description: "Premium leather white sneakers with minimalist design.",
    images: ["/images/products/fashion_sneakers.png"],
    category: "Fashion",
    inStock: true,
    stockCount: 45,
    details: ["Full-grain leather upper", "Cushioned memory foam insole", "Durable vulcanized sole", "Debossed WOXLY branding"],
    specs: [{ name: "Material", value: "Genuine Leather" }, { name: "Color", value: "White" }],
    vendor: "Woxly Apparel"
  },
  {
    id: "f4",
    name: "Woxly Matte Black Watch",
    slug: "woxly-matte-black-watch",
    price: 399.00,
    originalPrice: 499.00,
    rating: 4.9,
    reviewCount: 78,
    description: "Sleek minimalist black watch with premium leather strap.",
    images: ["/images/products/fashion_watch.png"],
    category: "Fashion",
    inStock: true,
    stockCount: 20,
    details: ["Quartz movement", "Matte black stainless steel case", "Genuine black leather strap", "Water resistant up to 3ATM"],
    specs: [{ name: "Case Size", value: "40mm" }, { name: "Strap Material", value: "Leather" }],
    vendor: "Woxly Apparel"
  }
];
